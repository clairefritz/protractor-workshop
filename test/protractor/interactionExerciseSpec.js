...
describe("Interaction exercises", function () {
    describe("The grandfather of all knowledge", function () {
        ...
        it('should answer any question', function () {
            ...
            var question = element(by.name('question')).sendKeys('Bla?');
            element(by.className('question__button')).click();
            var answerElement = element(by.className('answer')); /* implement me */
        ...
        it('should not be able to ask an empty question', function () {
            ...
            var question = element(by.name('question')).sendKeys('   ');
            var buttonElement = element(by.className('question__button')); /* implement me */
